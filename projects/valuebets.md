...
In terms of the method, my plan is to tarin a model. In terms of evaluation, I will be evaluating which model is better by assessing each model's EV and ROI for both the home and away team. I'm looking at EV because it gives us a sense of for each marginal/incremental bet, what we can expect and then ROI to look at the returns over time.
